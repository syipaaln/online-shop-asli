...
<div class="container">
    <div class="row justify-content-center">
        <form class="search-form w-full mb-3" action="{{ route('adminSearchUser') }}" method="GET">
        ...
        <div class="card border-0 shadow-sm rounded">
                    <div class="card-body bg-white">
                        ...
                        @endif
                        <a href="{{ route('adminManageUserCreate') }}" class="btn btn-md btn-success mb-3">ADD USER</a>
                        <table class="table">
                            <thead>
                                <tr>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                  <li>
                                                    <a class="dropdown-item" href="{{ route('adminManageUserEdit', $user->id) }}">Edit</a>
                                                  </li>
                                                  <li>
